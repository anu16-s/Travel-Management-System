...
<head>
    ...
    <style>
        body {
           /* background: url('http://localhost:8082/siddhi/Media/image_video/bridge.jpg') no-repeat center;*/
        ...
        .card { position: relative; height: 400px; margin: 20px; color: white; border: none; overflow: hidden; border-radius: 15px; }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto d-flex flex-row">
                    <li class="nav-item mx-2"><a class="nav-link" href="http://localhost:8080/Storedb/front.html">Home</a></li>
    ...
    <div class="container content text-center">
        ...
        %>
            <div class="col-md-4 package-card" data-name="<%= rs.getString(2).toLowerCase() %>">
                <div class="card">
                    <img src="<%= rs.getString(3) %>" alt="Package Image">
...
<div class="container breadcrumb-container mt-3">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="tour.jsp">Tour/Home</a></li>
        </ol>
    </nav>
</div>
     <!-- About Us Section -->
